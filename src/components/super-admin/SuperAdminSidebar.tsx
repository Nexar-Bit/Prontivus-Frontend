    ...
    items: [
      {
        ...
        icon: Users,
        url: "/super-admin/relatorios/clientes-ativos",
      },
    ],
  },
];
...
export function SuperAdminSidebar() {
      ...
      >
        ...
        <Icon
          className={cn(
            ...
            active ? "text-purple-700" : "text-white/90 group-hover:text-white"
          )}
        />
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="px-6 py-6 border-b border-white/10">
        ...
        <div className="mt-4 px-2">
          <div className="flex items-center gap-2 px-3 py-2 bg-purple-600/30 rounded-lg border border-purple-400/30">
      ...
      <div className="flex-1 overflow-y-auto px-3 py-4 space-y-1 sidebar-scrollbar">
        {SUPER_ADMIN_MENU.map((menuGroup) => {
      ...
      <div className="px-4 py-4 border-t border-white/10 bg-white/5">
        <div className="flex items-center gap-3 mb-3">
          <Avatar className="h-10 w-10 border-2 border-purple-300/30">
            <AvatarImage src={avatarUrl || undefined} alt={user.username} />
            <AvatarFallback className="bg-purple-400/20 text-purple-200 border-purple-300/30 font-semibold">
              {avatarUrl ? (
      ...
      {isMobileMenuOpen && (
        <>
          <div
            ...
            onClick={() => setIsMobileMenuOpen(false)}
          />
          <div className="lg:hidden fixed inset-y-0 left-0 z-50 w-[280px] bg-purple-700 shadow-2xl transform transition-transform duration-300 ease-in-out">
  ...
  return (
    <>
      <MobileSidebar />
      <aside className="hidden lg:flex flex-col fixed left-0 top-0 h-full w-[240px] bg-purple-700 z-30">
        <SidebarContent />
      </aside>
    </>
  );
