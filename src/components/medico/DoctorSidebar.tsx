    ...
    items: [
      {
        title: "Dashboard",
        icon: LayoutGrid,
        url: "/medico/financeiro/dashboard",
      },
      {
        title: "Contas a Receber",
        icon: ReceiptText,
        url: "/medico/financeiro/contas-receber",
      },
      {
        title: "Contas a Pagar",
        icon: Wallet,
        url: "/medico/financeiro/contas-pagar",
      },
      {
        title: "Fluxo de Caixa",
        icon: TrendingUp,
        url: "/medico/financeiro/fluxo-caixa",
      },
      {
        title: "Inadimplência",
        icon: AlertCircle,
        url: "/medico/financeiro/inadimplencia",
      },
    ],
  },
  {
